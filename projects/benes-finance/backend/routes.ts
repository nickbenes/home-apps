...
// Only updates the fields present in the request body; supports explicit null to clear a field.
...
router.delete('/mappings/:id', (req, res) => {
  ...
  ).get(req.params.id) as { mapping_id: string; transaction_id: string; budget_item_id: string; allocated_amount: number } | undefined;
